...
<html lang="en">
  <head>
    ...
    <title>Jenkins CI/CD webhook Deployment</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <div class="container">
      ...
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Devops-toolchain.svg/1920px-Devops-toolchain.svg.png"
        alt="DevOps Tools"
        width="200" />
      <p class="projects-coming">
        &#x26A1; Many More Projects Coming Soon! &#x26A1;
      </p>
      <div class="footer">
        <p>
          &copy; <span>2025</span> Naga Parameswara Reddy | Keep Automating &
          Innovating &#x1F680;
        </p>
      </div>
    </div>
